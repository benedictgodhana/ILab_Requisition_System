    ...
    <div class="min-h-screen flex">
        ...
        <aside class="w-64 bg-white shadow-md h-screen transition-transform transform -translate-x-64 md:translate-x-0" id="sidebar">
            ...
            <div class="p-6 flex flex-col">
                <ul class="space-y-4">
                    <li>
                        <a href="/admin/dashboard" class="sidebar-link flex items-center {{ request()->is('dashboard') ? 'sidebar-active' : '' }}">
                    ...
                    <li>
                        <a href="/admin/items" class="sidebar-link flex items-center {{ request()->is('suppliers') ? 'sidebar-active' : '' }}">
