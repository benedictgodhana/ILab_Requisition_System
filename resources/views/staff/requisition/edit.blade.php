<x-app-layout>
    <div class="p-8 max-w-8xl mx-auto bg-white shadow-lg rounded-lg">
        <h2 class="text-3xl font-semibold mb-6 text-blue-600">Edit Requisition</h2>
        ...
        <form action="{{ route('requisitions.update', $requisition->id) }}" method="POST">
            ...
            <div class="grid grid-cols-2 gap-6 mb-6">
                ...
                <div>
                    ...
                    <span class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">{{ $requisition->status->name }}</span>
                </div>
